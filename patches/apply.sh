...
echo ""
echo "NOTE: hardy.patch was applied on the feat/cspcl-v2 base. Before building hardy,"
echo "checkout feat/rdp-v2 (per README Step 4) and apply patches/hardy-rdp-v2.patch —"
echo "it adapts cspcl/src/{lib.rs,transport.rs} to that branch's cspcl API and repoints"
echo "the [patch.crates-io] cspcl paths at this repo's cspcl/ instead of a personal checkout."
